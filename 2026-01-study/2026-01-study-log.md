...
# 🗓️ 2026-01-12 (월)
**1. 스프링부트 복습 - 김영한의 스프링 입문 강의 복습**
- **학습 내용**: 스프링 프로젝트 환경, 서버의 응답 생성 방식, 웹 애플리케이션 계층 구조 간 의존 관계, 스프링 빈을 등록하는 두가지 방법, 스프링 DB 접근 기술 등

- **스프링부트 블로그를 구현하며 전체적인 실전 흐름을 훑어본 후, 원리적인 부분을 더 탄탄하게 하기 위해 스프링 개념 학습을 진행했다.** 일부는 노션 및 블로그에 정리했다.   
  → [[아키텍처] 웹 애플리케이션 계층 구조와 의존 관계 (ft. 스프링 빈)](https://velog.io/@hjy648012/%EC%95%84%ED%82%A4%ED%85%8D%EC%B2%98-%EC%9B%B9-%EC%95%A0%ED%94%8C%EB%A6%AC%EC%BC%80%EC%9D%B4%EC%85%98-%EA%B3%84%EC%B8%B5-%EA%B5%AC%EC%A1%B0%EC%99%80-%EC%9D%98%EC%A1%B4-%EA%B4%80%EA%B3%84-ft.-%EC%8A%A4%ED%94%84%EB%A7%81-%EB%B9%88)

- **ORM, JPA, Hibernate 개념 간 연관성**을 더 명확히 드러낼 수 있도록 이전에 작성했던 글을 수정하고, **JPA 매핑 어노테이션** 내용을 추가했다.   
  → [[Java] ORM, JPA, Hibernate (+ 엔티티 매니저, 영속성 컨텍스트)](https://velog.io/@hjy648012/%EC%9E%90%EB%B0%94-ORM-JPA-Hibernate)
